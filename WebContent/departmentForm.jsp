    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1 style="color:white;">Department Form</h1>
             <br><br><br><br><br><br>
			...
			Department Name: <input style="color:black;" name=”Name” value=”${department.name}” /> <br><br>
			Manager ID: <input style="color:black;" name=”managerID” value=”${department.managerID}” /> <br><br>
			Location ID: <input style="color:black;" name=”locationID” value=”${department.locationID}” /> <br><br><br>
			...
			<input class="btn btn-primary btn-xl page-scroll" type="submit" name="deparment" value="Submit" />
