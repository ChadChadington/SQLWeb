    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1 style="color:white;">Location Form</h1>
             <br><br><br><br><br><br>
             <form action=”updateLocation.do” method=”post”>
			<%-- Employee ID: ${employee.id}  --%>
			
			
			Location ID: <input style="color:black;" name=”locationID” value=”${location.id}” /> <br><br>
			...
			<input class="btn btn-primary btn-xl page-scroll" type="submit" name="location" value="Submit" />
