    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1 style="color:white;">Employee Form</h1>
             <br><br><br><br><br><br>
             <form action=”updateEmployee.do” method=”post”>
			<%-- Employee ID: ${employee.id}  --%>
			
			First Name: <input style="color:black;" name=”firstName” value=”${employee.firstname}” /> <br><br>
			Last Name: <input style="color:black;" name=”lastName” value=”${employee.lastame}” /> <br><br>
			Department ID: <input style="color:black;" name=”departmentId” value=”${employee.departmentId}” /> <br><br><br>
			...
			<input class="btn btn-primary btn-xl page-scroll" type="submit" name="employee" value="Submit" />
