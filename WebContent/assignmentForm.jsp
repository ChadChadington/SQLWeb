    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1 style="color:white;">Assignment Form</h1>
             <br><br><br><br><br><br>
             <form action=”updateAssignment.do” method=”post”>
			<%-- Employee ID: ${employee.id}  --%>
			
			
			Assignment ID: <input style="color:black;" name=”assignmentID” value=”${assignment.id}” /> <br><br>
			Employee ID: <input style="color:black;" name=”employeeID” value=”${assignment.employeeID}” /> <br><br>
			Project ID: <input style="color:black;" name=”projectID” value=”${assignment.projectID}” /> <br><br>
			...
			<input class="btn btn-primary btn-xl page-scroll" type="submit" name="assignment" value="Submit" />
